<div align="center">
  ...
  <hr />
  <br />
  <a href="https://pkg.go.dev/go.innotegrity.dev/runtimex" target="_blank">
    <img src="https://img.shields.io/badge/go-reference-2a7d98?style=for-the-badge" />
  </a>
  <a href="https://goreportcard.com/report/go.innotegrity.dev/runtimex" target="_blank">
...
Please review the [module documentation](https://pkg.go.dev/go.innotegrity.dev/runtimex) for details on how to properly the functions and classes contained in this module.
...
If you have questions about this project, find a bug or wish to submit a feature request, please [submit an issue](https://github.com/innotegrity/go-runtimex/issues).
